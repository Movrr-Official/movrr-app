...
const navigation = {
  rider: [
    ...
    { href: "/dashboard/rewards/shop", label: "Rewards Shop", icon: ShoppingBag },
  ...
  advertiser: [
    { href: "/dashboard", label: "Overview", icon: LayoutDashboard },
    { href: "/dashboard/campaigns", label: "Campaigns", icon: Megaphone },
    { href: "/dashboard/campaigns/create", label: "Create Campaign", icon: Megaphone },
  ...
  government: [
    { href: "/dashboard", label: "Overview", icon: LayoutDashboard },
    { href: "/dashboard/programmes", label: "Programmes", icon: Target },
    { href: "/dashboard/campaigns", label: "Campaigns", icon: Megaphone },
    { href: "/dashboard/compliance", label: "Compliance", icon: ShieldCheck },
    { href: "/dashboard/impact", label: "Impact", icon: LineChart },
...
const workspaceLabels: Record<ProductRole, string> = {
